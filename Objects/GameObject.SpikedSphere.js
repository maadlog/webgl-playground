SpikedSphere = function(ctx,vec3_position,radius,n) {
...
SpikedSphere.prototype = Object.create(GameObject.prototype);
SpikedSphere.prototype.constructor = SpikedSphere;

SpikedSphere.prototype.initBuffers = function(ctx) {
    var positions = [];
    var colorsArray = [];
...
SpikedSphere.prototype.render = function(ctx,viewMatrix,projectionMatrix) {
...
SpikedSphere.prototype.update = function(time) {
