Cube = function(ctx,vec3_position,side) {
...
AnimatedCube = function(ctx,vec3_position,side) {
  this.vec3_position = vec3_position;
  this.side = side;
...
AnimatedCube.prototype = Object.create(GameObject.prototype);
AnimatedCube.prototype.constructor = AnimatedCube;

AnimatedCube.prototype.initBuffers = function(ctx) {
  const positionBuffer = ctx.createBuffer();
...
AnimatedCube.prototype.render = function(ctx,viewMatrix,projectionMatrix) {
...
AnimatedCube.prototype.update = function(time) {
