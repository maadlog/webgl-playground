Tree = function(ctx,vec3_position,size) {
...
Tree.prototype.initBuffers = function(ctx) {
 ...
 const indicesArray = [
  ...
  this.Wireframe.customInitBuffers(ctx,positions,indicesArray);
};

Tree.prototype.render = function(ctx,viewMatrix,projectionMatrix) {
